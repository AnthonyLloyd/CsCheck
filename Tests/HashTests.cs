...
public class HashTests
{
    ...
    public void Pow10_Double()
    {
        ...
        Gen.Int[0, 31].Faster(Pow1, Pow2, Check.DontCheckEqual, repeat: 100).Output(writeLine);
        Gen.Int[0, 31].Faster(Pow3, Pow1, Check.DontCheckEqual, repeat: 100).Output(writeLine);
    }
}