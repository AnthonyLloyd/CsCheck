...
public class HashTests
{
    ...
    public void Pow10_Double()
    {
        ...
        Gen.Int[0, 31].Faster(i => Ignore(Pow1(i)), i => Ignore(Pow2(i)), repeat: 100).Output(writeLine);
        Gen.Int[0, 31].Faster(i => Ignore(Pow3(i)), i => Ignore(Pow1(i)), repeat: 100).Output(writeLine);
    }
}