...
The low ceremony Generators make CsCheck a good choice for C#, but the superior automatic shrinking and performance makes it a good choice for other languages also.
...
More to see in the [Tests](Tests). [MKL.NET](https://github.com/MKL-NET/MKL.NET/tree/master/Tests) also has 1,000+ tests using CsCheck.
